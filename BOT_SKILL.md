...
Este arquivo descreve o "skill" que um agente deve usar para entender e interagir com o código do bot.
O objetivo é fornecer contexto suficiente para que o agente responda a dúvidas, sugira melhorias ou explique o sistema.
...
- Servir como referência para implementação de novos recursos.
...
- Faz um único polling por par/intervalo para a Binance.
- Armazena candles no Redis (ou em memória se Redis indisponível).
- Serve esses dados a todos os bots, reduzindo o consumo de rate‑limit.
